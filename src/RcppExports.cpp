...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(custom_train(input_data, sparse_input_data, outcome_index, variable_names, mtry, num_trees, verbose, num_threads, min_node_size, sample_with_replacement, keep_inbag, sample_fraction, no_split_variables, seed, honesty, ci_group_size, alpha));
    return rcpp_result_gen;
END_RCPP
}
// custom_predict
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< unsigned int >::type ci_group_size(ci_group_sizeSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    rcpp_result_gen = Rcpp::wrap(quantile_train(quantiles, regression_splits, input_data, sparse_input_data, outcome_index, variable_names, mtry, num_trees, verbose, num_threads, min_node_size, sample_with_replacement, keep_inbag, sample_fraction, no_split_variables, seed, honesty, ci_group_size, alpha));
    return rcpp_result_gen;
END_RCPP
}
// quantile_predict
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type lambda(lambdaSEXP);
    Rcpp::traits::input_parameter< bool >::type downweight_penalty(downweight_penaltySEXP);
    rcpp_result_gen = Rcpp::wrap(regression_train(input_data, sparse_input_data, outcome_index, variable_names, mtry, num_trees, verbose, num_threads, min_node_size, sample_with_replacement, keep_inbag, sample_fraction, no_split_variables, seed, honesty, ci_group_size, alpha, lambda, downweight_penalty));
    return rcpp_result_gen;
END_RCPP
}
// regression_predict
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_grf_instrumental_train", (DL_FUNC) &_grf_instrumental_train, 22},
