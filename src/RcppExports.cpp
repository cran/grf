...
RcppExport SEXP _grf_custom_train(SEXP input_dataSEXP, SEXP sparse_input_dataSEXP, SEXP outcome_indexSEXP, SEXP mtrySEXP, SEXP num_treesSEXP, SEXP num_threadsSEXP, SEXP min_node_sizeSEXP, SEXP sample_fractionSEXP, SEXP seedSEXP, SEXP honestySEXP, SEXP honesty_fractionSEXP, SEXP ci_group_sizeSEXP, SEXP alphaSEXP, SEXP imbalance_penaltySEXP, SEXP clustersSEXP, SEXP samples_per_clusterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type input_data(input_dataSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(custom_train(input_data, sparse_input_data, outcome_index, mtry, num_trees, num_threads, min_node_size, sample_fraction, seed, honesty, honesty_fraction, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster));
    return rcpp_result_gen;
END_RCPP
}
// custom_predict
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<size_t> >::type clusters(clustersSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type samples_per_cluster(samples_per_clusterSEXP);
    rcpp_result_gen = Rcpp::wrap(quantile_train(quantiles, regression_splits, input_data, sparse_input_data, outcome_index, mtry, num_trees, num_threads, min_node_size, sample_fraction, seed, honesty, honesty_fraction, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster));
    return rcpp_result_gen;
END_RCPP
}
// quantile_predict
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<size_t> >::type clusters(clustersSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type samples_per_cluster(samples_per_clusterSEXP);
    rcpp_result_gen = Rcpp::wrap(regression_train(input_data, sparse_input_data, outcome_index, mtry, num_trees, num_threads, min_node_size, sample_fraction, seed, honesty, honesty_fraction, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster));
    return rcpp_result_gen;
END_RCPP
}
// regression_predict
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_grf_instrumental_train", (DL_FUNC) &_grf_instrumental_train, 20},
